		...
		<div class="col-lg-10">
			...
			<div class="card ps-3 pe-3 pt-3 mb-4" id="card-menu-pelayanan">
				...
				<div class="row row-cols-2 row-cols-md-4 row-cols-sm-2 g-1 justify-content-center mt-3">
					<div class="col">
						<a href="<?= base_url('survey/index_igd') ?>" class="nav-link mb-3">
					...
					<div class="col" id="left">
						<a href="<?= base_url('survey/index_ralan') ?>" class="nav-link mb-3">
							<div class="card gambar shadow_cus">
					...
					<div class="col" id="right">
						<a href="<?= base_url('survey/index_ranap') ?>" class="nav-link mb-3">
							<div class="card gambar shadow_cus">
