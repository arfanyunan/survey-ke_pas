										...
										<div class="card-header bg-white">
											<div class="row mt-2">
												<div class="col-sm-3 col-md-3">
													<button type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#tambahBangsal"><i class="fas fa-plus mr-2"></i>Tambah Bangsal</button>
												</div>
													...
													foreach ($data_admin as $dt_admin) : ?>
														<tr>
															...
															<td class="text-center col-sm-1">
																<button type="button" class="btn bg_admin text-white btn-sm" data-toggle="modal" data-target="#editBangsal<?= $dt_admin['kd_bangsal']; ?>"><i class="fas fa-pen mr-2"></i>Edit Data</button>
															</td>
														</tr>
														<!-- Modal Edit Bangsal -->
