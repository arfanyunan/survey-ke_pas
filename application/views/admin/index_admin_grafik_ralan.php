    						...
    						<div class="container-fluid">
    							<div class="row mb-2">
    								<div class="col-lg-12">
										...
										<h4 class="card-title text-center">Tabel Grafik Survey Kepuasan Pasien Rawat Jalan Bulan <b><?php $bulan = date('m'); $this->input->post('bulan') == TRUE ? $bulan =  $this->input->post('bulan') : $bulan = date('m'); echo $bulan; ?>-<?php $this->input->post('tahun') == TRUE ? $tahun =  $this->input->post('tahun') : $tahun = date('Y'); echo $tahun; ?></b></h4>
