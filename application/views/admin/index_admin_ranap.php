                                        ...
                                        <div class="col-md-3">
                                            <form action="<?= base_url('admin/rekap'); ?>" method="POST">
                                                <div class="input-group input-group-sm">
                                                    <input type="date" class="form-control" name="date_Isi" required>
                                                    <span class="input-group-append">
                                                        <button type="submit" class="btn btn-info btn-flat">Lihat Rekap</button>
                                                    </span>
                                                </div>
                                            </form>
                                        </div>
                                                ...
                                                <div class="card-header">
                                                    <div class="row">
                                                        <div class="col-sm-12 col-md-6">
                                                            <h3 class="card-title"><i class="fas fa-user-tie"></i>Tabel Data Survey Kepuasan Pasien Ranap</h3>
                                                        </div>
                                                        <div class="col-sm-12 col-md-6">
                                                    ...
                                                    <table id="tabelsurvey" class="table table-bordered table-striped table-hover dt-responsive nowrap" style="width: 100%;">
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th class="text-center">Pertanyaan 7a</th>
                                                                <th class="text-center">Pertanyaan 7b</th>
                                                                <th class="text-center">Pertanyaan 7c</th>
                                                                <th class="text-center">Pertanyaan 7d</th>
                                                                <th class="text-center">Pertanyaan 8</th>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            foreach ($data_admin as $dt_admin) : ?> <tr>
                                                                    ...
                                                                    <td class="text-center"><?= $dt_admin['p7a']; ?></td>
                                                                    <td class="text-center"><?= $dt_admin['p7b']; ?></td>
                                                                    <td class="text-center"><?= $dt_admin['p7c']; ?></td>
                                                                    <td class="text-center"><?= $dt_admin['p7d']; ?></td>
                                                                    <td class="text-center"><?= $dt_admin['p8']; ?></td>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="card card-success card-outline">
                                                <div class="card-header">
                                                    <div class="row">
                                                        <div class="col-sm-12 col-md-6">
                                                            <h5 class="card-title"><i class="fas fa-user-tie"></i>Tabel Data Survey Kepuasan Pasien Ranap</h5>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="card-body table-responsive">
